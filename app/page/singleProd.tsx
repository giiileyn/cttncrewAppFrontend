    ...
    return (
        <ScrollView style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <View style={{ backgroundColor: '#FEC536', padding: 10, flexDirection: 'row', alignItems: 'center' }}>
                <TouchableOpacity>
                    <Image source={require('D:/cttncrwApp/frontend/assets/icons/menu.png')} style={{ width: 25, height: 25 }} />
                </TouchableOpacity>
                <TextInput
                ...
                />
                <TouchableOpacity>
                    <Image source={require('D:/cttncrwApp/frontend/assets/icons/cart.png')} style={{ width: 25, height: 25, marginLeft: 10 }} />
                </TouchableOpacity>
            </View>
            ...
            <View style={{ padding: 10 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginVertical: 10 }}>
                    <Image source={require('D:/cttncrwApp/frontend/assets/icons/shipping.png')} style={{ width: 20, height: 20 }} />
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginVertical: 20 }}>
                    <TouchableOpacity style={{ backgroundColor: '#FEC536', padding: 15, borderRadius: 5, flex: 1, marginRight: 5, alignItems: 'center' }}>
                        <Text style={{ color: '#000', fontWeight: 'bold' }}>Add To Cart</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{ backgroundColor: '#FF9900', padding: 15, borderRadius: 5, flex: 1, marginLeft: 5, alignItems: 'center' }}>
